// author: https://github.com/trietho/flutter_beep/blob/master/LICENSE
import 'dart:async';
...
class SystemSound {
  ...
  static Future<void> playSysSound(int soundId, {int msDuration = 0}) async {
    if (Platform.isFuchsia || Platform.isLinux || Platform.isMacOS || Platform.isWindows) {
      print('UNIMPLEMENTED - playSysSound [ $soundId ] for: Platform.isFuchsia || Platform.isLinux || Platform.isMacOS || Platform.isWindows');
      return null;
    }
  ...
  static Future<void> beep({bool success = true, int msDuration}) {
    int soundId;
